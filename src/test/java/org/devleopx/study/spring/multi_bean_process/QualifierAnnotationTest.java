...
@Slf4j
@SpringBootTest(classes = {QualifierAnnotationTest.App.class})
@DisplayName("2개의 빈이 등록되는 경우 @Qualifier를 annotaion으로 만들어 매칭을 할 수 있다.")
public class QualifierAnnotationTest {
    ...
    void run(){
        ...
        // then
        assertThat(ret).isEqualTo("sub connection");
    }
